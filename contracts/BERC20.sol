...
/**
 * @title BERC20 implements {ERC20} standards with expended features for Bumper
 * @author crypto-pumpkin
 * Symbol example:
 *  RC_Dai_wBTC_2_2021
 *  RR_Dai_wBTC_2_2021
 */
contract BERC20 is IBERC20, ERC20Permit, Initializable, Ownable {
  ...
  /// @notice Bumper specific function
  ...
  /// @notice Bumper specific function
  function burnByBumper(address _account, uint256 _amount) external override onlyOwner returns (bool) {
